...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        init();
        TextView tx1 = (TextView) findViewById(R.id.btn_login1);
        ...
        TextView tx2 = (TextView) findViewById(R.id.btn_find_psw);
        tx2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(LoginActivity.this,FindBack.class);
                //startActivity(intent);
                startActivityForResult(intent,REQUEST_CODE_GO_TO_REGIST);
            }
        });
    ...
    private void init() {
        ...
        tv_register=findViewById(R.id.btn_login1);
